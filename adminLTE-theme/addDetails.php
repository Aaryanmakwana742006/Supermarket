...
if($_POST)
{
    ...
    $q=mysqli_query($connection,"insert into tbl_order_details(order_id,product_id,product_qty,product_price)
    values('{$order_id}','{$product_id}','{$product_qty}'),'{$product_price}'") or die(mysqli_error($connection));
    if($q)
    {
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Details of Order Detail</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form"  method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="order_id" class="form-control" id="exampleInputEmail1">
                  </div>
