                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $q = mysqli_query($connection, "select *from tbl_product") or die(mysqli_error($connection));
                                        while ($data = mysqli_fetch_array($q)) {
                                            ...
                                            echo"<td><a href='edit3.php?eid={$data['product_id']}'>Edit</a>|<a href='viewproduct.php?did={$data['product_id']}'onclick='return confirmDelete()'>Delete</a></td>";
                                            echo "</tr>";
                                        }
                                        ?>
                                    </tbody>
